...
<header data-am-widget="header" class="am-header am-header-default header"
    ...
    <h1 class="am-header-title"><a href="javascript:void(0)" class="" style="color: #333;">反馈意见查询</a></h1>
...
<script type="text/javascript">
    ...
    function createHtml(json) {
        ...
        for (var i in array) {
            ...
            html += "<span style='float:right; margin-right:10px;'></span>";
            html += "</div>";
            html += "</div>";
            html += "</a>";
            html += "</div>";
