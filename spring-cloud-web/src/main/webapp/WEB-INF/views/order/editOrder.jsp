...
<div class="am-tabs qiehuan" data-am-tabs style="margin-top:70px;">
    ...
    <div class="am-tabs-bd">
        ...
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
            ...
            <textarea placeholder="填写定制信息" id="selfInf" name="selfInf" class="tab-input">${data.ext}</textarea>

            <textarea placeholder="备注补充" id="remark" name="remark" class="tab-input">${data.remark}</textarea>
            <button type="button" onclick="editOrder()" class="tab-btn">确认修改</button>
