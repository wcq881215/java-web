                ...
                <div class="col-md-6">
                    <form action="" method="post" onsubmit="">
                        <div id="comments-sec">
                            ...
                            <div class="form-group  ">
                                <label>联系电话</label> <input type="text" name="phone" id="phone" value="${data.phone}"
                                                           class="form-control1 ng-invalid ng-invalid-required ng-touched"
                                                           required="required"/>
                            </div>

                            <div class="form-group  ">
                                <label>负责人</label> <input type="text" name="leader" id="leader" value="${data.leader}"
                                                          class="form-control1 ng-invalid ng-invalid-required ng-touched"
                                                          required="required"/>
                            </div>
                            ...
                            <div class="form-group  ">
                                <label>所属公司</label> <input type="text" name="groups" id="groups" value="${data.groups}"
                                                           class="form-control1 ng-invalid ng-invalid-required ng-touched"
                                                           required="required"/>
                            </div>
