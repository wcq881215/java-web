...
<div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default footer " id="">
    <ul class="am-navbar-nav am-cf am-avg-sm-4">
        <li>
            <a href="/" class="">
                <span class=""><img src="/images/nav_home_focus.png"/></span>
                <span class="am-navbar-label" >首页</span>
            </a>
        </li>
        <li>
            <a href="/cust/work" class="">
                <span class=""><img src="/images/nav_work.png"/></span>
                <span class="am-navbar-label">工作</span>
            </a>
        </li>
        <li>
            <a href="/cust/message" class="">
                <span class=""><img src="/images/nav_msg.png"/></span>
                <span class="am-navbar-label">消息</span>
            </a>
        </li>

        <li>
            <a href="/cust/my" class="">
                <span class=""><img src="/images/nav_my.png"/></span>
